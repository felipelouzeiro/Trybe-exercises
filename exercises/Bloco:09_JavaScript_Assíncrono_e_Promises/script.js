...
// const getPlanet = (planeta) => {
//   console.log("Returned planet: ", planeta);
// };
...
// const sendMarsTemperature = (temperatura) => console.log(`Mars temeperature is: ${temperatura} degree Celsius`); 
...
if (callback) { 
  ...
  setTimeout(() => console.log(error), messageDelay());
}
}; 
